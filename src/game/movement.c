...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/21 19:16:46 by absaadan          #+#    #+#             */
/*   Updated: 2025/08/21 19:16:48 by absaadan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	try_move_player(t_game *game, double angle_offset, double move_step,
		int direction)
{
	double	new_x;
	double	new_y;
