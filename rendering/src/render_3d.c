...
void render_3d_view(t_game *game)
{
    ...
    {
        strip_params.ray_angle = game->player.rotation - (data.fov_radians / 2.0) + (ray_index * data.angle_step);
...
void draw_wall_strip(t_game *game, t_strip_render_params *params)
{
    ...
    corrected_distance = ray.distance * cos(params->ray_angle - game->player.rotation);
